...
echo -e "\n${YELLOW}Direct access links:${NC}"
echo -e "- In-cluster service URL: http://billing.mesh-demo.svc.cluster.local:8080/checkout"
echo -e "- Ingress host URL: http://billing.local/checkout"
...
echo -e ""
echo -e "${YELLOW}Run these verification commands:${NC}"
...
echo -e ""
echo -e "${YELLOW}Credentials and secrets:${NC}"
